...
set_property PACKAGE_PIN K2 [get_ports {face_select_signals[0]}]
set_property PACKAGE_PIN J2 [get_ports {face_select_signals[1]}]
set_property PACKAGE_PIN J3 [get_ports {face_select_signals[2]}]
set_property PACKAGE_PIN H4 [get_ports {face_select_signals[3]}]
set_property PACKAGE_PIN J4 [get_ports {face_select_signals[4]}]
set_property PACKAGE_PIN G3 [get_ports {face_select_signals[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {face_select_signals[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {face_select_signals[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {face_select_signals[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {face_select_signals[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {face_select_signals[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {face_select_signals[5]}]